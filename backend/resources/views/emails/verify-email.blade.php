                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06); padding: 40px;">
                    ...
                    <tr>
                        <td align="center" style="padding-top: 20px;">
                            <h2 style="font-size: 28px; font-weight: 700; color: #2d3748; margin: 0;">Verify Your Email Address</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 0;">
                            <a href="{{ $frontendUrl }}" target="_blank" style="background-color: #991b1b; color: #ffffff; font-size: 16px; font-weight: bold; text-decoration: none; padding: 15px 35px; border-radius: 6px; display: inline-block;">
                                Verify Email
                            </a>
                        </td>
                    </tr>
